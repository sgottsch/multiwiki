...
import similarity.RelativeDocumentPositionSimilarity;
import similarity.Similarity;
import similarity.SimilarityType;
import similarity.links.EntityAllTypesJaccardSimilarity;
import similarity.links.EntityOverlapSimilarity;
import similarity.links.EntitySimilarity;
import similarity.links.ExternalLinkHostSimilarity;
import similarity.links.ExternalLinkSimilarity;
import similarity.links.InternalLinkSimilarity;
import similarity.neighbour.PreviousSentenceCosineSimilarity;
import similarity.neighbour.WikiParagraphEntitySimilarity;
import similarity.text.DictionaryCosineSimilarity;
import similarity.text.DictionaryOverlapSimilarity;
import similarity.text.NGramSimilarity;
import similarity.text.TextLengthSimilarity;
import similarity.text.TextOverlapSimilarity;
import similarity.text.WordCosineSimilarity;
import similarity.time.HeidelTimeCosineSimilarity;
import similarity.time.HeidelTimeSimilarity;
import similarity.time.HeidelTimeStringsOverlapSimilarity;
import similarity.time.ParagraphTimeSimilarity;
