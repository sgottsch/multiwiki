...
import de.l3s.db.tables.Author_DB;
...
import de.l3s.extractor.ArticleExtractor;
import de.l3s.extractor.ExtractionConfigThreadSafe;
import de.l3s.extractor.ExtractionDataStore;
import de.l3s.extractor.Extractor;
import de.l3s.extractor.ParagraphExtractor;
import de.l3s.extractor.RevisionExtractor;
import de.l3s.translate.Language;
import de.l3s.util.DateUtil;
